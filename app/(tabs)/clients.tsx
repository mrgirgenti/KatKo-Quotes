...
const styles = StyleSheet.create({
  ...
  headerTop: { flexDirection: 'row', alignItems: 'baseline', gap: 10, paddingHorizontal: 20, paddingTop: 20, paddingBottom: 10 },
  pageTitle: { fontSize: 24, fontWeight: '800' as const, color: Colors.light.text },

  statsBar: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 20, marginBottom: 12, backgroundColor: Colors.light.background, borderRadius: 10, borderWidth: 1, borderColor: Colors.light.border, paddingVertical: 10, paddingHorizontal: 6 },
  ...
  pill: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20, borderWidth: 1.5, borderColor: Colors.light.border, backgroundColor: Colors.light.background },
  ...
  pillCount: { backgroundColor: Colors.light.border, borderRadius: 10, minWidth: 17, height: 17, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 3 },
  pillCountText: { fontSize: 10, fontWeight: '700' as const, color: Colors.light.textSecondary },

  searchRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 20, paddingBottom: 12, alignItems: 'center' },
  searchBox: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: Colors.light.background, borderRadius: 10, borderWidth: 1, borderColor: Colors.light.border, paddingHorizontal: 12, paddingVertical: 9 },
  searchInput: { flex: 1, fontSize: 14, color: Colors.light.text, outlineStyle: 'none' as any },
  importBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, borderWidth: 1.5, borderColor: Colors.light.tint, paddingHorizontal: 12, paddingVertical: 9, borderRadius: 10 },
  importBtnText: { fontSize: 13, fontWeight: '600' as const, color: Colors.light.tint },
  addBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: Colors.light.tint, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 10 },
  addBtnText: { fontSize: 14, fontWeight: '700' as const, color: '#fff' },
  toolBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 10, paddingVertical: 9, borderRadius: 10, borderWidth: 1, borderColor: Colors.light.border, backgroundColor: Colors.light.surface },
  ...
  mobileSortRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 6, paddingHorizontal: 16, paddingVertical: 8 },
  mobileSortLabel: { fontSize: 12, color: Colors.light.textSecondary, fontWeight: '600' as const, marginRight: 2 },
  mobileSortBtn: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, borderWidth: 1, borderColor: Colors.light.border, backgroundColor: Colors.light.surface },
  ...
  filterPanel: { backgroundColor: Colors.light.surface, borderBottomWidth: 1, borderBottomColor: Colors.light.border, paddingHorizontal: 20, paddingVertical: 12, gap: 10 },
  filterRow: { flexDirection: 'row', gap: 12, flexWrap: 'wrap', alignItems: 'flex-end' },
  filterGroup: { gap: 5 },
  filterGroupLabel: { fontSize: 10, fontWeight: '700' as const, color: Colors.light.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.4 },
  filterInputBox: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: Colors.light.background, borderRadius: 8, borderWidth: 1, borderColor: Colors.light.border, paddingHorizontal: 9, paddingVertical: 6, minWidth: 150 },
  filterInput: { flex: 1, fontSize: 13, color: Colors.light.text, outlineStyle: 'none' as any },
  filterChip: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, borderWidth: 1.5, borderColor: Colors.light.border, backgroundColor: Colors.light.background },
  filterChipOn: { borderColor: Colors.light.tint, backgroundColor: '#FFF4EE' },
  filterChipText: { fontSize: 12, color: Colors.light.textSecondary, fontWeight: '500' as const },
  filterChipTextOn: { color: Colors.light.tint, fontWeight: '700' as const },
  clearFiltersBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, borderWidth: 1.5, borderColor: Colors.light.error, backgroundColor: '#FEF2F2' },
  clearFiltersBtnText: { fontSize: 12, color: Colors.light.error, fontWeight: '600' as const },

  tableHeader: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 8, backgroundColor: '#000000' },
  ...
  sortBtnText: { fontSize: 11, fontWeight: '700' as const, color: '#FFFFFF', textTransform: 'uppercase' as const, letterSpacing: 0.4 },
  sortBtnTextActive: { color: Colors.light.tint },

  badge: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 12, borderWidth: 1, alignSelf: 'flex-start' as const },
  badgeDot: { width: 6, height: 6, borderRadius: 3 },
  badgeText: { fontSize: 11, fontWeight: '700' as const },

  hubBadgeActive: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 4, backgroundColor: '#DCFCE7', borderRadius: 6, paddingHorizontal: 7, paddingVertical: 3, alignSelf: 'flex-start' as const, borderWidth: 1, borderColor: '#86EFAC' },
  hubBadgeInactive: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 4, backgroundColor: '#374151', borderRadius: 6, paddingHorizontal: 7, paddingVertical: 3, alignSelf: 'flex-start' as const, borderWidth: 1, borderColor: '#4B5563' },
  ...
  viewBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 7, backgroundColor: Colors.light.tint },
  viewBtnText: { fontSize: 12, fontWeight: '700' as const, color: '#fff' },
  menuBtn: { width: 28, height: 28, borderRadius: 7, borderWidth: 1, borderColor: Colors.light.border, backgroundColor: '#fff', alignItems: 'center' as const, justifyContent: 'center' as const },
  rowMenuBackdrop: { position: 'absolute' as any, top: 0, left: 0, right: 0, bottom: 0 },
  rowMenuDropdown: { position: 'absolute' as any, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: Colors.light.border, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.12, shadowRadius: 12, elevation: 8, minWidth: 190, paddingVertical: 4, zIndex: 9999 },
  rowMenuItem: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 10, paddingHorizontal: 14, paddingVertical: 10 },
  ...
  orgCard: { backgroundColor: Colors.light.surface, borderRadius: 14, borderWidth: 1, borderColor: Colors.light.border, padding: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  ...
  colPickerCard: { backgroundColor: Colors.light.surface, borderRadius: 16, padding: 20, width: 340, maxWidth: '90%' as any },
  colPickerSub: { fontSize: 13, color: Colors.light.textSecondary, marginBottom: 14 },
  colPickerRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: Colors.light.border },
  ...
  emptyAddBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8, backgroundColor: Colors.light.tint, paddingHorizontal: 18, paddingVertical: 10, borderRadius: 10 },
  ...
  chooseOption: { flexDirection: 'row', alignItems: 'center', gap: 14, padding: 14, borderRadius: 14, borderWidth: 2, borderColor: Colors.light.border, backgroundColor: Colors.light.background },
  ...
  continueBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: Colors.light.tint, borderRadius: 12, paddingVertical: 14, marginTop: 4 },
  continueBtnText: { color: '#fff', fontWeight: '700' as const, fontSize: 15 },

  fieldLabel: { fontSize: 12, fontWeight: '700' as const, color: Colors.light.textSecondary, textTransform: 'uppercase' as const, letterSpacing: 0.4, marginTop: 14, marginBottom: 6 },
  textInput: { backgroundColor: Colors.light.background, borderRadius: 10, borderWidth: 1, borderColor: Colors.light.border, paddingHorizontal: 13, paddingVertical: 10, fontSize: 15, color: Colors.light.text },
  notesInput: { minHeight: 60, textAlignVertical: 'top' as const },
  rowInputs: { flexDirection: 'row', gap: 10 },
  typePickerBtn: { backgroundColor: Colors.light.background, borderRadius: 10, borderWidth: 1, borderColor: Colors.light.border, paddingHorizontal: 13, paddingVertical: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  typeDropdown: { backgroundColor: Colors.light.surface, borderRadius: 10, borderWidth: 1, borderColor: Colors.light.border, marginTop: 4, overflow: 'hidden', maxHeight: 240 },
  typeDropdownItem: { paddingHorizontal: 14, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: Colors.light.border, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  orgSearchRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 14, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: Colors.light.border },
  ...
  statusOption: { paddingHorizontal: 12, paddingVertical: 7, borderRadius: 8, borderWidth: 1.5, borderColor: Colors.light.border, backgroundColor: Colors.light.background },
  ...
  saveBtn: { backgroundColor: Colors.light.tint, paddingVertical: 14, borderRadius: 12, alignItems: 'center', marginTop: 16 },
