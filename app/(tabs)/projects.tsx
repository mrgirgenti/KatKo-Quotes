...
const styles = StyleSheet.create({
  ...
  badge: { alignSelf: 'center', paddingHorizontal: 9, paddingVertical: 3, borderRadius: DS.radius.pill, borderWidth: 1 },
  badgeText: { fontSize: 11, fontWeight: '700' },
  opBadge: { alignSelf: 'center', paddingHorizontal: 8, paddingVertical: 2, borderRadius: DS.radius.pill, borderWidth: 1, maxWidth: 150 },
