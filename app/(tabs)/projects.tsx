...
const styles = StyleSheet.create({
  ...
  mobileSortRow: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: DS.spacing.lg, paddingVertical: 10 },
  mobileSortLabel: { fontSize: 12, color: Colors.light.textSecondary, fontWeight: '600' },
  mobileSortBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: DS.radius.pill, borderWidth: 1, borderColor: Colors.light.border },
  ...
  cardList: { padding: DS.spacing.lg, gap: DS.spacing.sm, paddingBottom: 40 },
  card: { backgroundColor: Colors.light.surface, borderRadius: DS.radius.lg, padding: DS.spacing.md, borderWidth: 1, borderColor: Colors.light.border, gap: 5 },
