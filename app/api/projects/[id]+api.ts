  ...
  try {
    ...
    const result = await pool.query(
      `UPDATE "Project" SET
        ...
        "inHandsDate" = $5, "invoiceNumber" = $6,
        "hasOnlineFee" = $7, "hasSalesTax" = $8, "hasCardFee" = $9,
        calculations = $10::jsonb, "salesData" = $11::jsonb, "lineItemsData" = $12::jsonb,
        "frontendStatus" = $13, status = $14::"ProjectStatus",
        "activeDate" = $15, "isLocked" = $16, "lockedDate" = $17,
        "exportedToSheets" = $18, "exportedToSheetsDate" = $19,
        "quoteSentAt" = $20, "waveInvoiceLink" = $21,
        "updatedAt" = NOW()
