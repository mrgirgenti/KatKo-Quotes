  ...
  try {
    ...
    const result = await pool.query(
      `UPDATE "Contact" SET
        ...
        birthday                    = $15,
        "weddingAnniversary"        = $16,
        "spouseName"                = $17,
        children                    = $18,
        "favoriteSportsTeam"        = $19,
        "favoriteDrink"             = $20,
        "shirtSize"                 = $21,
        "hatSize"                   = $22,
        "personalNotes"             = $23,
        "preferredDecorationMethod" = $24,
        "preferredApparelBrand"     = $25,
        "typicalOrderSize"          = $26,
        "taxExempt"                 = $27,
        "purchaseOrderRequired"     = $28,
        "preferredShippingMethod"   = $29,
        "updatedAt" = NOW()
      WHERE id = $30 AND "organizationId" = $31 RETURNING *`,
      [
        body.firstName,
        body.lastName,
        body.email ?? null,
