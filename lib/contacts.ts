...
export function toEnrichedContact(row: any): Contact {
  ...
  return {
    ...
    weddingAnniversary: row.weddingAnniversary ?? undefined,
    spouseName: row.spouseName ?? undefined,
    children: row.children ?? undefined,
    favoriteSportsTeam: row.favoriteSportsTeam ?? undefined,
    favoriteDrink: row.favoriteDrink ?? undefined,
    shirtSize: row.shirtSize ?? undefined,
    hatSize: row.hatSize ?? undefined,
    personalNotes: row.personalNotes ?? undefined,
    preferredDecorationMethod: row.preferredDecorationMethod ?? undefined,
    preferredApparelBrand: row.preferredApparelBrand ?? undefined,
    typicalOrderSize: row.typicalOrderSize ?? undefined,
    taxExempt: row.taxExempt ?? false,
    purchaseOrderRequired: row.purchaseOrderRequired ?? false,
    preferredShippingMethod: row.preferredShippingMethod ?? undefined,
