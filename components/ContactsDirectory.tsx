...
const styles = StyleSheet.create({
  ...
  statsBar: { flexDirection: 'row', alignItems: 'center', marginHorizontal: DS.spacing.lg, marginBottom: DS.spacing.md, paddingVertical: 12, paddingHorizontal: 16, backgroundColor: '#EBEBEB', borderRadius: DS.radius.md },
